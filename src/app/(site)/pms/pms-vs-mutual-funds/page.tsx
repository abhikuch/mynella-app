...
import { PmsVsMutualFundsArticleBody } from "@/components/pillar-articles/bodies/PmsCompareTaxArticles";
import type { PillarFaq } from "@/lib/pillar-jsonld";

const PATH = "/pms/pms-vs-mutual-funds" as const;
  ...
  return (
    <PillarArticlePage
      ...
      crumbs={[
        { label: "Home", href: "/" },
        { label: "PMS", href: "/pms" },
        { label: "PMS vs mutual funds" },
      ]}
      Body={PmsVsMutualFundsArticleBody}
      faqs={faqs}
