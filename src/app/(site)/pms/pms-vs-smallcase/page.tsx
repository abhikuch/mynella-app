...
import { PmsVsSmallcaseArticleBody } from "@/components/pillar-articles/bodies/PmsCompareTaxArticles";
import type { PillarFaq } from "@/lib/pillar-jsonld";

const PATH = "/pms/pms-vs-smallcase" as const;
  ...
  return (
    <PillarArticlePage
      ...
      crumbs={[
        { label: "Home", href: "/" },
        { label: "PMS", href: "/pms" },
        { label: "PMS vs smallcase" },
      ]}
      Body={PmsVsSmallcaseArticleBody}
      faqs={faqs}
