...
import { SebiAlgoRulesArticleBody } from "@/components/pillar-articles/bodies/SebiAlgoRulesArticle";
import type { PillarFaq } from "@/lib/pillar-jsonld";

const PATH = "/algo/sebi-rules-algo-trading" as const;
  ...
  return (
    <PillarArticlePage
      ...
      crumbs={[
        ...
        { label: "SEBI rules & algo trading" },
      ]}
      Body={SebiAlgoRulesArticleBody}
      faqs={faqs}
