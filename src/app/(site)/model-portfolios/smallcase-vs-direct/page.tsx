...
import { SmallcaseVsDirectArticleBody } from "@/components/pillar-articles/bodies/SmallcaseVsDirectArticle";
import type { PillarFaq } from "@/lib/pillar-jsonld";

const PATH = "/model-portfolios/smallcase-vs-direct" as const;
...
export default function Page() {
  return (
    <PillarArticlePage
      ...
      crumbs={[
        { label: "Home", href: "/" },
        { label: "Model portfolios", href: "/model-portfolios" },
        { label: "Smallcase vs direct" },
      ]}
      Body={SmallcaseVsDirectArticleBody}
      faqs={faqs}
