...
const routeKey = portfolioPageCopyRouteKey("quanto", "mid-cap");

export async function generateMetadata(): Promise<Metadata> {
  const portfolio = await getMergedPortfolio("quanto", "mid-cap");
  return pageMetadataForRoute(
    routeKey,
    {
title: portfolio?.name ?? "Quanto Mid Cap",
...
export default async function MidCapPage() {
  const portfolio = await getMergedPortfolio("quanto", "mid-cap");
